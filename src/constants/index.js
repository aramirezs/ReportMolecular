...
//Test Molecular
export const TEST_MOLECULAR_IN_REQUEST = "TEST_MOLECULAR_IN_REQUEST";
export const TEST_MOLECULAR_IN_SUCCESS = "TEST_MOLECULAR_IN_SUCCESS";
export const TEST_MOLECULAR_IN_FAILURE = "TEST_MOLECULAR_IN_FAILURE";
